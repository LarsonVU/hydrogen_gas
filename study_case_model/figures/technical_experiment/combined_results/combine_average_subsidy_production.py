...
def plot_hydrogen_production(h2_dict, folder):
    ...
    plt.xlabel('Max H2 Production') 
    plt.ylabel('Average Hydrogen Production (GWh)')
    plt.title('Average Hydrogen Production vs Max H2 Value')
    plt.grid(alpha=0.3, axis="y")
    plt.legend() 
...
def plot_subsidy_cost(h2_dict, folder):
    ...
    plt.title('Average Subsidy Cost vs Max H2 Value')
    plt.grid(alpha=0.3, axis="y")
    plt.legend()
...
def plot_objective_values(objective_dict, folder):
    ...
    plt.title('Objective Value Effect vs Max H2 Value')
    plt.grid(alpha=0.3, axis="y")
    plt.legend()
