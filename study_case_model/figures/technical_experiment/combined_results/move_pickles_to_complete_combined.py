...
# Paths
# ---------------------------
src1 = Path("study_case_model/figures/technical_experiment/run_09426")
dst_base = Path("study_case_model/figures/technical_experiment/combined_runs_new")

# ---------------------------
# Run merge
# ---------------------------
src_run_five = Path("study_case_model/figures/technical_experiment/run_0")
copy_run_from_src1(src1, src_run_five, run="run5")

merge_runs([src_run_five], dst_base)