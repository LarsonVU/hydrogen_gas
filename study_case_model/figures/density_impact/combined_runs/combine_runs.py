...
def main():
    ...
    parser.add_argument("--output", default="study_case_model/figures/density_impact/combined_runs/combined.csv")
    ...
    folder = "study_case_model/figures/density_impact/combined_runs/"
