...
# =========================
subsidies = [0] + [30 + i * 2 for i in range(6)] + [45 +i for i in range(4)] + [70]  # 0,5,...,80
deviations = [0, 0.05, 0.1, 0.2 ,1]
runs = 2

data_folder = "study_case_model/scenario_variables/subsidy_experiment/run_27326/"
pickle_folder = "study_case_model/figures/subsidy_experiment/run_27326/"
threads = 32
